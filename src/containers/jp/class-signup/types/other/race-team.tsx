...
const data: ClassType = {
	...
	description: (<React.Fragment>
		Racing skills are honed through practices and CBI weekly racing series. The team competes in regattas at sailing centers throughout the area.
		...
		please contact the Junior Program Director, Fiona O'Connor, at <a href="mailto:fiona@community-boating.org">fiona@community-boating.org</a>.
	</React.Fragment>)
}
