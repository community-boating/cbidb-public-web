...
export const FactaInfoDiv = (props: { infos: string[], dontEscapeHTML?: boolean, suffixes?: React.ReactNode[] }) => (
				...
				<div style={{padding: "1px 0 0 0", height: "100%"}}>
					<div className="alert-subject">
						...
						<div className="alert-subject-content">
							<div className="alert-subject-content-title">Info</div>
						</div>
					</div>
				</div>
			</td>	
